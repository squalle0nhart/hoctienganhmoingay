...
public class TestListenActivity extends Activity implements TextToSpeech.OnInitListener {
    ImageView ivSpeak;
    ...
    protected void onResume() {
        super.onResume();
        if (mTextToSpeech == null) {
            mTextToSpeech = new TextToSpeech(mContext, TestListenActivity.this);
        }
    }
    ...
    private class ButtonChoiceOnClick implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (position == randomRightChoice) {
                // Chọn đúng
                mListChoiceButton[position].setTextColor(Color.BLUE);
